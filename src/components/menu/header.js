...
const Header = function ({ className }) {
  ...
  useEffect(()=>{
    if(account!=null){
      getEtherBalance(window.ethereum,account)
    }
  },[account,etherAmount])
        ...
        <div className='row w-100-nav'>
            ...
            <Breakpoint l down>
              {showmenu && (
                <div className='menu'>
                  ...
                  <div className='navbar-item'>
                  <NavLink to='/collection/1'>My Collection</NavLink>
                </div>
                  {/* <div className='navbar-item'>
          ...
          <div className='mainside'>
            ...
            <div className='logout'>
              {
                account == null ?(
                  <button className='btn-wallet' onClick={()=>handleConnect()}>Connect Wallet</button>

                ):(
                  <button className='btn-wallet' onClick={()=>handleDisconnect()}>Disconnect</button>
