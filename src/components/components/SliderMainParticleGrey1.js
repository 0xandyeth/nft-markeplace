 ...
 <div className="container">
    <div className="row align-items-center">
          <div className="col-md-6">
              ...
              <h6> <span className="text-uppercase color">Dealmintr Market</span></h6>
              <Reveal className='onStep' keyframes={fadeInUp} delay={300} duration={900} triggerOnce>
              <h1 className="col-white">Discover <span className="color">rare</span> digital promo NFTs</h1>
              </Reveal>
              ...
              <span onClick={()=> window.open("/login", "_self")} className="btn-main inline white lead">Signin</span>
